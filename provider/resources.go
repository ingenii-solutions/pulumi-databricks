...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"databricks_external_location":           {Tok: makeResource(mainMod, "ExternalLocation")},
			"databricks_git_credential":              {Tok: makeResource(mainMod, "GitCredential")},
			"databricks_global_init_script":          {Tok: makeResource(mainMod, "GlobalInitScript")},
			"databricks_grants":                      {Tok: makeResource(mainMod, "Grants")},
			...
			"databricks_library":                     {Tok: makeResource(mainMod, "Library")},
			...
			"databricks_mlflow_webhook":              {Tok: makeResource(mainMod, "MLFlowWebhook")},
			...
			"databricks_storage_credential":          {Tok: makeResource(mainMod, "StorageCredential")},
			...
			"databricks_table":                       {Tok: makeResource(mainMod, "Table")},
			"databricks_token":                       {Tok: makeResource(mainMod, "Token")},
			"databricks_user":                        {Tok: makeResource(mainMod, "User")},
			"databricks_user_role":                   {Tok: makeResource(mainMod, "UserRole")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"databricks_catalogs":                {Tok: makeDataSource(mainMod, "getCatalogs")},
			"databricks_clusters":                {Tok: makeDataSource(mainMod, "getClusters")},
			...
			"databricks_jobs":                    {Tok: makeDataSource(mainMod, "getJobs")},
			...
			"databricks_schemas":                 {Tok: makeDataSource(mainMod, "getSchemas")},
			"databricks_spark_version":           {Tok: makeDataSource(mainMod, "getSparkVersion")},
			"databricks_tables":                  {Tok: makeDataSource(mainMod, "getTables")},
