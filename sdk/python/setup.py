        ...
        try:
            check_call(
                [
                    ...
                    "0.2.1",
                    "--server",
                    "https://github.com/ingenii-solutions/pulumi-databricks/releases/download/v0.2.1",
                ]
            )
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource databricks 0.2.1 --server https://github.com/ingenii-solutions/pulumi-databricks/releases/download/v0.2.1`
                """)
            else:
                raise
