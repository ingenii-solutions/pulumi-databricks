...
__all__ = ['AzureDbfsFileArgs', 'AzureDbfsFile']

@pulumi.input_type
class AzureDbfsFileArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a AzureDbfsFile resource.
        """
...
class _AzureDbfsFileState:
    def __init__(__self__, *,
                 ...
                 source: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering AzureDbfsFile resources.
        """
        if content_base64 is not None:
            pulumi.set(__self__, "content_base64", content_base64)
...
class AzureDbfsFile(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a AzureDbfsFile resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AzureDbfsFileArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a AzureDbfsFile resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param AzureDbfsFileArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AzureDbfsFileArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AzureDbfsFileArgs.__new__(AzureDbfsFileArgs)
        ...
        super(AzureDbfsFile, __self__).__init__(
            'databricks:databricks/azureDbfsFile:AzureDbfsFile',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            md5: Optional[pulumi.Input[str]] = None,
            path: Optional[pulumi.Input[str]] = None,
            source: Optional[pulumi.Input[str]] = None) -> 'AzureDbfsFile':
        """
        Get an existing AzureDbfsFile resource's state with the given name, id, and optional extra
        ...
        __props__ = _AzureDbfsFileState.__new__(_AzureDbfsFileState)
        ...
        __props__.__dict__["path"] = path
        __props__.__dict__["source"] = source
        return AzureDbfsFile(resource_name, opts=opts, __props__=__props__)
