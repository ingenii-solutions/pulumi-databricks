...
class _ExportableConfig(types.ModuleType):
    ...
    @property
    def azure_use_msi(self) -> Optional[str]:
        return __config__.get('azureUseMsi')
    ...
    @property
    def http_timeout_seconds(self) -> Optional[str]:
        return __config__.get('httpTimeoutSeconds')
